...
1. 优先使用 `environment-qwen3-local.yml` 创建独立的 `qwen3-dpo` 环境；完整安装、验证和旧 `stdplm` overlay 兼容步骤见 `docs/new_device_environment.md`。
...
4. 开始前阅读 README.md、本文件、docs/new_device_environment.md、docs/qwen3_prompt_reasonableness_gate.md、docs/s0_1_protocol.md 和 docs/new_idea_report.md。
